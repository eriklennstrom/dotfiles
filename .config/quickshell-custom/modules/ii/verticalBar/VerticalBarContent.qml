            ...
            RippleButton { // Right sidebar button
                ...
                ColumnLayout {
                    ...
                    BatteryIndicator {
                        ...
                        Layout.fillWidth: true
                        Layout.bottomMargin: visible ? indicatorsColumnLayout.realSpacing : 0
                    }
                    Revealer {
                        vertical: true
                    ...
                    Item {
                        ...
                        Layout.alignment: Qt.AlignHCenter
                        implicitWidth: airpodsIcon.implicitWidth
                        implicitHeight: airpodsIcon.implicitHeight
                        ...
                        Timer {
                            ...
                            onTriggered: airpodsCheckProc.running = true
                        }

                        Process {
                            id: airpodsCheckProc
                            command: ["bluetoothctl", "info", "14:14:7D:E3:0B:B8"]
                            stdout: StdioCollector {
                                id: checkStdout
                                onStreamFinished: {
                                    airpodsItem.airpodsConnected = checkStdout.text.includes("Connected: yes");
                                }
                            }
                        }

                        Process {
                            id: airpodsConnectProc
                            command: ["bluetoothctl", "connect", "14:14:7D:E3:0B:B8"]
                            onExited: (exitCode, exitStatus) => {
                                airpodsItem.toggling = false;
                                airpodsCheckProc.running = true;
                            }
                        }

                        Process {
                            id: airpodsDisconnectProc
                            command: ["bluetoothctl", "disconnect", "14:14:7D:E3:0B:B8"]
                            onExited: (exitCode, exitStatus) => {
                                airpodsItem.toggling = false;
                                airpodsCheckProc.running = true;
                            }
                        ...
                        MaterialSymbol {
                            ...
                            text: "headphones"
                            iconSize: Appearance.font.pixelSize.larger
                            color: airpodsItem.toggling
                                ? Appearance.colors.colOutlineVariant
                                : airpodsItem.airpodsConnected
                                    ? Appearance.colors.colOnLayer0
                                    : Appearance.colors.colOutlineVariant
                            opacity: airpodsItem.toggling ? 0.5 : 1.0
                        ...
                        MouseArea {
                            ...
                            onClicked: {
                                if (!airpodsItem.toggling) {
                                    airpodsItem.toggling = true;
                                    if (airpodsItem.airpodsConnected)
                                        airpodsDisconnectProc.running = true;
                                    else
                                        airpodsConnectProc.running = true;
                                }
                            }
                        }
                    }
